...
public class StreamTest {
    public static void main(String[] args) {
        ...
        integers.stream()
                .filter(item -> item > 5) //6 6 7 9 8 10 12 14 14
        ...
        Student s33 = new Student("aa", 30);
        Student s44 = new Student("dd", 40);
        List<Student> studentList = Arrays.asList(s11, s22, s33, s44);
        ...
        List<Student> ss = Arrays.asList(sd1, sd2);
        ss.stream()
                .peek(o -> o.setAge(100))
                .forEach(System.out::println);
        ...
        System.out.println(list11.stream().allMatch(e -> e > 10)); // false
        System.out.println(list11.stream().noneMatch(e -> e > 10)); // true
        System.out.println(list11.stream().anyMatch(e -> e > 4)); // true
        System.out.println(list11.stream().findFirst().get()); // 1
        System.out.println(list11.stream().findAny().get()); // 2
        System.out.println(list11.stream().count()); // 5
        //System.out.println(list.stream().max(Integer::compareTo).get()); // 5
